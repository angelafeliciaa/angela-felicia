        ...
        <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
                ...
                <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'}
                                        onClick={() => onUpdateActiveLink('skills')}>Top Skills</Nav.Link>
             ...
             <span className="navbar-text">
                <div className="social-icon">
                  <a href="https://www.linkedin.com/in/angela-feliciaa/"><img src= {navIcon1}/></a>
                  <a href="https://github.com/angelafeliciaa/"><img src= {navIcon2} alt=""/></a>
                  <a href="#"><img src= {navIcon3} alt=""/></a>
                 </div>
                  <a href="https://www.linkedin.com/in/angela-feliciaa/" className="vvd-link">
